...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{
      asset("assets/front_end/asset/css/commoncalculatorab59.css")
...
.flex-item li a{
  ...
  letter-spacing: 0.5px; */
      ...
      .yellow-button:hover {
        background-color: #373d42; /* Change the color when hovering */
      }
    </style>
  </head>
        ...
        <div class="row">
          <div class="col-md-4 col-lg-4 col-xl-3">
            <div class="second-logo">
              <a href="{{ route('home') }}"
                ><img
                  src="{{ asset('assets/front_end/asset/img/logo.png') }}"
                  alt=""
              /></a>
            </div>
          </div>
