        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8 col-xl-6">
                  <div>
                      <ul class="nav-links" style="display: flex; justify-content: center; list-style: none;">
...
<di       v class="flex-item  animate__animated animate__fadeIn">
        ...
        <div class="footer-widget">
          <div class="footer-title">
            ...
            <div class="elementor-element elementor-element-6adad94f elementor-widget elementor-widget-text-editor two_elementor_element animated slideInUp" data-id="6adad94f" data-element_type="widget" data-settings="{&quot;_animation&quot;:&quot;slideInUp&quot;}" data-widget_type="text-editor.default">
              <div class="elementor-widget-container two_elementor_element">
                <p class="elementor-widget-container" style="color:white;font-weight: 300; font-size: 19px;", sans-serif;>To adopt channels and methodologies for increasing Accessibility and offer products and services keeping in mind the Affordability of the clients. MyZeon is India’s premier fintech company.&nbsp;</p>
              </div>
            </div>
          </div>
        </div>
