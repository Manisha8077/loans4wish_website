    ...
    <div id="showpanel" class="hidden bg-gray-100 p-6 fade-in text-center" style="margin-top: 100px;">
        <div class="flex-container justify-between space-x-4">
            ...
            <div class=" flex-item animate__animated animate__fadeIn">
                ...
                <ul class="ulText" style="text-align: left;">
                    ...
                    <li>
                        ...
                        <a href="{{ route('loan-against-property') }}" class="hover:underline font-medium" style="white-space: nowrap;">LOAN AGAINST PROPERTY</a>
            ...
            <!-- FINANCIAL TOOLS -->
               ...
               <ul style="text-align: left;"><li><a href="{{ route('ifsc') }}" class="hover:underline font-medium">IFSC</a></li>
                <div>
                <a style = " cursor: pointer; color: #374151;" class="hover:underline font-medium" id= "anchorCal" onclick="CaluculatorFunction()" >CALCULATOR<i class="fa-solid fa-caret-down"></i></a>
                <ul id="calList" class="ulText" >
                        ...
                        <li class="hover:underline font-medium">
                            ...
                            <a href="{{ route('gst-calculator') }}" class="dropdown-item"><b>GST Calculator</b></a>
