        ...
        <ul class="list-unstyled animated slideInUp">
          <li class="mb-2">
            <a href="https://goo.gl/maps/CPzMDB39QHEE4Kud9" target="_blank" rel="noopener" class="color">
              <i class="fa fa-home"  aria-hidden="true" style="color: #ffd756; font-size: 22px; margin-right: 10px;"  ></i> A-47, Sector-2 Noida, <br>UP - 201301
            </a>
          </li>
          <li class="mb-2">
            <a href="mailto:info@myzeon.com" class="color">
              <i class="fas fa-mail-bulk" style="color: #ffd756; font-size: 25px; margin-right: 10px;" ></i> info@myzeon.com
            </a>
          </li>
          <li>
            <a href="tel:0120-4198166" class="color">
              <i class="fa fa-phone"aria-hidden="true" style="color: #ffd756; font-size: 25px; margin-right: 10px;" ></i> 0120-4198166
            </a>
          </li>
        </ul>
      </div>
