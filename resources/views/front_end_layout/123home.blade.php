...
.animated-button:hover {
    background-color: rgb(33, 30, 30) ; /* Change the background color on hover */
}
    </style>
  ...
  letter-spacing: 0.5px; */
      ...
      .yellow-button:hover {
        background-color: #2e3234; /* Change the color when hovering */
      }
    </style>
  </head>
    ...
    <div class="container-fluid">
        ...
        <div id="showpanel">
                ...
                <div class="flex-container">
                  ...
                  <div class="flex-item">
                    <p class="Finance"><b>FINANCIAL TOOLS</b></p>
                    <ul class="submenu" id="showcalu">
                        <li class="financelist">
                        <span class="submenu-button" ></span> <a href="#" id="showCaluculatorItem">CALCULATOR</a>
                        <ul>
                          ...
                          <li class="showCaluculatorItem">
                            <a href="{{ route('fd-calculator') }}"
                              >FD Calculator</a
                            >
                          </li>
                          <li class="showCaluculatorItem">
                            <a href="{{ route('ppf-deposit') }}"
                              >PPF Calculator</a
                            >
                          </li>
                ...
                <ul>
                  <li>
                    <div class="footer-element-down">
                      ...
                      <a
                        href="https://goo.gl/maps/sR25qkXZMv1ErHNMA"
                        class="footer-anchor-tag"
                      >
                        A-47, Sector-2 Noida, <br />Uttar Pradesh - 201301</a
                      >
                    </div>
                  </li>
                  <li>
                    <div class="footer-element-down">
                      ...
                      <a href="mailto:info@myzeon.com" class="footer-anchor-tag"
                        >info@myzeon.com <span>reply within 2 Hours</span></a
                      >
                    </div>
                  </li>
                  <li>
