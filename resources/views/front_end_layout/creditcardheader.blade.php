...
"https://unpkg.com/tailwindcss@^1.0/dist/tailwind.min.css" rel="stylesheet">
    ...
    <style>
        ...
        #showpanel {
            ...
            width: 50%;
            height: 57%;
            box-shadow: 8px 11px 24px -3px #1338BE;
        }
...
<body class="js">
    ...
    <div x-data="{ open: false }">
        ...
        <header class="second-header animated">
                    ...
                    <div class="col-md-8 col-lg-8 col-xl-6">
                        <div>
                            <ul style="display: flex; justify-content: center; list-style: none;">
                                <li style="margin: 15px;"><a href="#showpanel" style="color: white;"
                                        x-on:click="open = ! open" class="btn"><b>ALL SERVICES</b></a></li>
                                <li style="margin: 15px;"><a href="https://www.myzeon.com/contact" style="color: white;"
                                        x-on:click="open = ! open" class="btn"><b>CONTACT US</b></a></li>
                                <li style="margin: 15px;"><a href="#" style="color: white;"
                                        x-on:click="open = ! open" class="btn"><b>ABOUT
                                            US</b></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-xl-3">
                        <div id="cssmenu" style="position: absolute; top: 0; right: 0;">
                            <ul class="flex justify-end">
                                <li class="relative">
                                    <button class="y-button animated-button"
                                        onclick="location.href='{{ route('check-cibil-score') }}'">CIBIL SCORE</button>
                                </li>
                                <li>
                                    <button class="y-button animated-button"
                                        onclick="location.href='{{ route('business-loan') }}'">APPLY NOW</button>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div x-show="open"
         ...
         class="bg-gradient-to-r from-blue-500 to-yellow-500 p-6 fade-in text-center flex flex-col">
         >

            <div id="showpanel" class="bg-gradient-to-r from-blue-500 to-yellow-500 p-6 fade-in text-center">
                <div class="flex-container justify-between space-x-4">

                    <!-- LOANS -->
                    <div class="flex-item animate__animated animate__fadeIn w-full">
                        <p class="text-xl font-semibold text-white mb-4">LOANS</p>
                        <ul class="text-white">
                            <li>
                                <a href="{{ route('personal-loan') }}" class="hover:underline font-medium">PERSONAL
                                    LOAN</a>
                            </li>
                            <li>
                                <a href="{{ route('business-loan') }}" class="hover:underline font-medium">BUSINESS
                                    LOAN</a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <a href="{{ route('loan-against-property') }}"
                                    class="hover:underline font-medium">LOAN
                                    AGAINST PROPERTY</a>
                    ...
                    <div class="flex-item animate__animated animate__fadeIn w-full">
                        ...
                        <ul class="text-white">
                            <li>
                                <a href="{{ route('credit-cards') }}" class="hover:underline font-medium">CREDIT
                                    CARD</a>
                            </li>
                            <li>
                                <a href="{{ route('debit-cards') }}" class="hover:underline font-medium">DEBIT
                                    CARD</a>
                            </li>
                        </ul>
                    ...
                    <div class="flex-item animate__animated animate__fadeIn w-full">
                        ...
                        <ul class="text-white">
                            ...
                            <li><a href="{{ route('mutual-funds') }}" class="hover:underline font-medium">MUTUAL
                                    FUNDS</a>
                            </li>

                            <li><a href="{{ route('fixed-deposit') }}" class="hover:underline font-medium">FIXED
                                    DEPOSIT</a>
                            </li>
                    ...
                    <div class="flex-item animate__animated animate__fadeIn w-full">
                        ...
                        <ul class="submenu" id="showcalu">
                            ...
                            <li class="financelist">
                                ...
                                <a href="#" id="showCaluculatorItem"
                                    class="group-hover:underline font-medium">CALCULATOR</a>
                                ...
                                <ul>
                                    ...
                                    <li class="showCaluculatorItem">
                                        ...
                                        <a href="{{ route('cal-home-loan') }}"
                                            class="hover:underline font-medium">Home
                                            Loan</a>
                                    ...
                                    <li class="showCaluculatorItem">
                                        ...
                                        <a href="{{ route('gst-calculator') }}"
                                            class="hover:underline font-medium">GST
                                            Calculator</a>
    ...
    <section class="footer-area footer-two footer-three section-padding animate__animated animate__fadeInUp">
                ...
                <div class="col-md-3  animate__animated animate__fadeInUp">
                    <div class="footer-widget">
                        <div class="footer-title">
                            <div class="elementor-element elementor-element-19acb440 elementor-widget elementor-widget-image two_elementor_element animated slideInUp"
                                data-id="19acb440" data-element_type="widget"
                                ...
                                <div class="elementor-widget-container two_elementor_element">
                                    <a href="https://www.myzeon.com/" class="two_elementor_element">
                                        <noscript class="two_elementor_element">
                                            <img decoding="async" width="300" height="120"
                                                src="https://www.myzeon.com/wp-content/uploads/2023/05/logo-1-300x78.png"
                                                class="attachment-medium size-medium wp-image-552" alt="Myzeon"
                                                srcset="https://www.myzeon.com/wp-content/uploads/2023/05/logo-1-300x78.png 300w, https://www.myzeon.com/wp-content/uploads/2023/05/logo-1-768x200.png 768w, https://www.myzeon.com/wp-content/uploads/2023/05/logo-1.png 799w"
                                                sizes="(max-width: 300px) 100vw, 300px" />
                                        </noscript>
                                        <img decoding="async" width="300" height="100"
                                            src="https://www.myzeon.com/wp-content/uploads/2023/05/logo-1-300x78.png"
                                            data-src="https://www.myzeon.com/wp-content/uploads/2023/05/logo-1-300x78.png"
                                            class="lazy attachment-medium size-medium wp-image-552 two_elementor_element entered loaded"
                                            alt="Myzeon"
                                            data-srcset="https://www.myzeon.com/wp-content/uploads/2023/05/logo-1-300x78.png 300w, https://www.myzeon.com/wp-content/uploads/2023/05/logo-1-768x200.png 768w, https://www.myzeon.com/wp-content/uploads/2023/05/logo-1.png 799w"
                            ...
                            <div class="elementor-element elementor-element-6adad94f elementor-widget elementor-widget-text-editor two_elementor_element animated slideInUp"
                                data-id="6adad94f" data-element_type="widget"
                                data-settings="{&quot;_animation&quot;:&quot;slideInUp&quot;}"
                                data-widget_type="text-editor.default">
                                <div class="elementor-widget-container two_elementor_element">
                                    <p class="elementor-widget-container"
                                        style="color:white;font-weight: 300; font-size: 19px;", sans-serif;>To adopt
                                        channels and methodologies for increasing Accessibility and offer products and
                                        services keeping in mind the Affordability of the clients. MyZeon is India’s
                                        premier fintech company.&nbsp;</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <center>
            ...
            <div class="footer-social-icons">
                ...
                <a href="https://www.facebook.com/people/Myzeon-Loans/61551106282364/" target="_blank"
                    class="social-icon facebook">
                    <i class="fab fa-facebook"></i>
                </a>
                <a href="https://www.linkedin.com/in/myzeon-loans-2ab7b928b/" target="_blank"
...
?> Myzeon. All Rights Reserved | Developed by <a href="https://webthinksolution.com/">Web Think Solution</a></p> -->
    ...
    In this example, we are using the hover function to add the "animate__animated" and "animate__fadeIn" classes to the
    element with the class "footer-element" when you hover over it. When you move the mouse away, the classes are
    removed to stop the animation.

    You can replace the animation classes and customize the animation properties as needed. Make sure you have defined
    the custom animation classes in your CSS or have included the appropriate animation library if you are using
