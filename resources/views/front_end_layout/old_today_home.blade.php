    ...
    <div class="container">
        <div class="row" style="margin-top: 19px;">
            ...
            <div class="col-md-8 col-lg-8 col-xl-6">
                <div>
                    <ul class="nav-links d-flex justify-content-center list-unstyled fs-5">
                        <li style="margin: 15px;"><a href="#showpanel" id="showAllloans"><b>ALL SERVICES</b></a></li>
                        <li style="margin: 15px;"><a href="{{ route('contact') }}"><b>CONTACT US</b></a></li>
                        <li style="margin: 15px;"><a href="{{ route('about') }}"><b>ABOUT US</b></a></li>
                    </ul>
                </div>
            </div>
...
<div id="showpanel" class="hidden bg-gradient-to-r from-blue-500 to-yellow-500 p-6 fade-in text-center">
  <div class="flex-container justify-between space-x-4">
      ...
      <div class="flex-item animate__animated animate__fadeIn">
          ...
          <ul class="text-white" style="text-align: left;">
              <li>
                  <a href="{{ route('mutual-funds') }}" class="hover:underline font-medium">MUTUAL FUNDS</a>
              </li>
              <li>
                  <a href="{{ route('fixed-deposit') }}" class="hover:underline font-medium">FIXED DEPOSIT</a>
              </li>
          </ul>
      </div>
...
<footer class="footer-area footer-two footer-three section-padding animate__animated animate__fadeInUp" style="background-color: #your-bg-color;">
  <div class="container">
    <div class="row">
          ...
          <div class="footer-title">
            <div class="d-flex justify-content-center">
              <a href="https://www.myzeon.com">
                <img class="img-fluid" src="https://www.myzeon.com/wp-content/uploads/2023/05/logo-1-300x78.png" alt="Myzeon">
              </a>
            </div>
          </div>
        </div>
      ...
      <!-- Quick Links -->
      <div class="col-md-2 col-sm-4 animate__animated animate__fadeInUp">
      ...
      <div class="col-md-2 animate__animated animate__fadeInUp">
        <div class="footer-element">
          <div class="footer-title">
            <h4 class="footer-main-heading" style="white-space: nowrap;">Important Links</h4>
          </div>
          <div class="elementor-widget">
            <ul>
      ...
      <div class="col-md-3 animate__animated animate__fadeInUp">
        <div class="footer-element">
          <div class="footer-title">
            <h4 class="footer-main-heading" style="padding-left: 20px;">Contact us</h4>
          </div>
          <div class="elementor-widget">
...
In this example, we are using the hover function to add the "animate__animated" and "animate__fadeIn" classes to the element with the class "footer-element" when you hover over it. When you move the mouse away, the classes are removed to stop the animation.

You can replace the animation classes and customize the animation properties as needed. Make sure you have defined the custom animation classes in your CSS or have included the appropriate animation library if you are using predefined animation classes.
