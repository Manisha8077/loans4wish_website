...
<body class="js">
    ...
    <header class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #1338BE;">
        <div class="container-fluid">
            ...
            <div class="conainer-fluid" style="background-color: whitesmoke;">
                <button class="navbar-toggler" type="button" data-target="#navbarNav" aria-controls="navbarNav"
                    aria-expanded="false" aria-label="Toggle navigation" id="toggleNavbar">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ml-auto navBarItemButton d-flex justify-content-between">
                    ...
                    <li class="nav-item headerMainContentButton"><a
                            ...
                            href="http://192.168.120.228/myzeon_web/index.php/contact"><b>CONTACT US</b></a></li>
                    <li class="nav-item headerMainContentButton"><a
                            class="btn btn-primary text-yellow-500 font-bold text-2xl"
                ...
                <ul class="navbar-nav ml-auto d-flex">
                    <!-- Right Side Buttons -->
                    <li class="nav-item headerMainContentButton">
                        <a class="btn btn-primary text-yellow-500 font-bold text-2xl"
                            href="http://192.168.120.228/myzeon_web/index.php/contact-us">APPLY NOW</a>
                    </li>
                    <li class="nav-item headerMainContentButton">
                        <a class="btn btn-primary text-yellow-500 font-bold text-2xl"
                            href="http://192.168.120.228/myzeon_web/index.php/check-cibil">CIBIL SCORE</a>
                    </li>
                </ul>
            </div>
        </div>
    </header>
    <div id="showpanel" class="hidden bg-gray-100 p-6 fade-in text-center" style="margin-top: 100px;">
        <div class="flex-container justify-between space-x-4">

            <!-- LOANS -->
            <div class=" flex-item animate__animated animate__fadeIn">
                <p class="text-xl font-semibold mb-4 blueText" style="margin-left: -100px;">LOANS</p>
                <ul class="ulText" style="text-align: left;">
                    <li>
                    ...
                    <li>
                        <a href="{{ route('loan-against-property') }}" class="hover:underline font-medium"
                            style="white-space: nowrap;">LOAN AGAINST PROPERTY</a>
                    </li>
                </ul>
            ...
            <div class="flex-item animate__animated animate__fadeIn">
                <p class="text-xl font-semibold blueText mb-4" style="margin-left: -101px;">CARDS</p>
                <ul class="ulText" style="text-align: left;">
                    <li>
            ...
            <div class="flex-item animate__animated animate__fadeIn">
                ...
                <p class="text-xl font-semibold blueText mb-4" style="margin-left: -30px;">INVESTMENTS</p>
            ...
            <div class="flex-item animate__animated animate__fadeIn">
                <p class="text-xl font-semibold blueText mb-4" style="margin-left: 8px;">FINANCIAL TOOLS</p>
                <ul style="text-align: left;">
                    <li><a href="{{ route('ifsc') }}" class="hover:underline font-medium">IFSC</a></li>
                    <div>
                        <a style = " cursor: pointer; color: #374151;" class="hover:underline font-medium"
                            id= "anchorCal" onclick="CaluculatorFunction()">CALCULATOR<i
                                class="fa-solid fa-caret-down"></i></a>
                        <ul id="calList" class="ulText">
                            <li class="hover:underline font-medium">

                                <a href="{{ route('cal-personal-loan') }}" class="dropdown-item"><b>Personal
                                        Loan</b></a>
                            </li>

                            <li class="hover:underline font-medium">

                                <a href="{{ route('cal-business-loan') }}" class="dropdown-item"><b>Business
                                        Loan</b></a>
                            </li>

                            <li class="hover:underline font-medium">
                                <a href="{{ route('cal-home-loan') }}" class="dropdown-item"><b>Home Loan</b></a>
                            </li>

                            <li class="hover:underline font-medium">
                                <a href="{{ route('cal-car-loan') }}" class="dropdown-item"><b>Car Loan</b></a>
                            </li>
                            ...
                            <li class="hover:underline font-medium">
                                <a href="{{ route('fd-calculator') }}" class="dropdown-item"><b>FD Calculator</b></a>
                            </li>

                            <li class="hover:underline font-medium">
                                <a href="{{ route('ppf-deposit') }}" class="dropdown-item"><b>PPF Calculator</b>
                                </a>
                            </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mt-4">
                        <div class="text-center animated slideInUp">
                            <a href="https://www.myzeon.com/">
                                <img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/logo.png"
                                    class="img-fluid1" alt="Company Logo"
                                    style="filter: hue-rotate(45deg) brightness(480); height:50px; width: 290px; height: 63px;">
                                <!-- <img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/logo.png"
                    ...
                    <div class="col-lg-2 col-md-6 mb-4 mt-4">
                        ...
                        <ul class="list-unstyled animated slideInUp">
                            <li class="mb-2"><a href="http://192.168.120.228/myzeon_web/index.php"
                                    class="color">Home</a></li>
                            <li class="mb-2"><a href="http://192.168.120.228/myzeon_web/index.php/about"
                                    class="color">About
                                    Us</a></li>
                            <!-- <li class="mb-2"><a href="https://www.myzeon.com/?page_id=1163" class="color">Why
                                    Choose Us</a></li> -->
                            <li class="mb-2"><a href="http://192.168.120.228/myzeon_web/index.php/contact"
                                    class="color">Contact
                                    us</a></li>
                    ...
                    <div class="col-lg-2 col-md-6 mb-4 mt-4">
                        ...
                        <hr class="mb-4">
                        <ul class="list-unstyled animated slideInUp">
                            <li class="mb-2"><a href="http://192.168.120.228/myzeon_web/index.php/personal-loan"
                                    class="color">Personal
                                    Loan</a></li>
                            <li class="mb-2"><a href="http://192.168.120.228/myzeon_web/index.php/business-loan"
                                    class="color">Business
                                    Loan</a></li>
                            <li class="mb-2"><a href="http://192.168.120.228/myzeon_web/index.php/home-loan"
                                    class="color">Home
                                    Loan</a></li>
                            <li class="mb-2"><a href="http://192.168.120.228/myzeon_web/index.php/car-loan"
                                    class="color">Car
                                    Loan</a></li>
                            <li><a href="http://192.168.120.228/myzeon_web/index.php/loan-against-property"
                                    class="color">Loan Against
                                    Property</a></li>
                        </ul>
                    </div>
                            ...
                            <li class="mb-2">
                                <a href="https://goo.gl/maps/CPzMDB39QHEE4Kud9" target="_blank" rel="noopener"
                                    ...
                                    <i class="fa fa-home" aria-hidden="true"
                                        style="color: #ffd756; font-size: 25px; margin: right 6px;"></i> A-47, Sector-2
                                    Noida,UP-201301
                                </a>
                            </li>
                            <li class="mb-2">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4 mt-4">
                        ...
                        <hr class="mb-4">
                        <ul class="list-unstyled animated slideInUp">
                            <li class="mb-2"><a href="http://192.168.120.228/myzeon_web/index.php/privacy-policy"
                                    class="color">Privacy
                                    Policy</a></li>
                            <li class="mb-2"><a
                                    href="http://192.168.120.228/myzeon_web/index.php/term-and-conditions"
                                    class="color">Term &
                                    Conditions</a></li>
                            ...
                            <div class="text-center  animated-icons">
                                <div class="animated slideInUp" style="margin-right: 260px; ">
                                    ...
                                    <a href="https://www.facebook.com/people/Myzeon-Loans/61551106282364/"
...
?> Myzeon. All Rights Reserved | Developed by <a href="https://webthinksolution.com/">Web Think Solution</a></p> -->
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"
        integrity="sha256-/xUj+3OJU5yExlq6GSBYTGTv2t6dPrgr9rDoGIt4v+m4=" crossorigin="anonymous"></script> --}}
    {{--
    <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js"
        integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous">
        </script> --}}
