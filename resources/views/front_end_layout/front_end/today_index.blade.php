...
<!-- change by mannu -->
<div class="container-fluid" style="overflow-y: hidden; height: auto;">
...
<div class="row">
<div class="col-lg-6" style="margin-left: 154px;">
...
<div class="sidebar col-sm-4" style="margin-top: 75px;">
...
<div class="col-lg-5 mx-auto" style="margin-top: 48px;">
  <div>
    <div class="section-title text-center col-md-8">
      <h2 style="color: #1338be; text-align: justify;">EMI CALCULATOR</h2>
    ...
    <div class="section-title text-center col-md-8">
      <h4 style="color: #1338be; text-align: justify; padding: 2px;"><b>Personal Loan EMI Calculator</b></h4>
    ...
    <div class="section-title text-center col-md-8">
      <h4 style="color: #1338be; text-align: justify;padding: 2px;"><b>Car Loan EMI Calculator</b></h4>
...
<!-- add slider by mannu -->
<div class="container-fluid">
  <h2 class="mt-5" style="text-align: center; color: #1338BE;"  ><b>LATEST BLOG</b></h2><br><br>
</div>
<!-- style="display: flex; justify-content: center; -->
<section>
  <div class="container-fluid d-flex justify-content-around align-items-stretch" style="height: 400px;">

    <div class="card custom-card"  style="width: 30rem; flex: 1; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); margin-right: 20px;">
      ...
      <div class="card-body d-flex flex-column">
        <h5 class="card-title"><a href="https://www.myzeon.com/blog/how-to-calculate-your-business-loan-emi-at-lower-rates">How To Calculate Your Business Loan EMI At Lower Rates?</a></h5>
        <p class="card-text">Planning to start a business but worried about funds? Are you looking for a business loan at a lower rate?</p>
        <a href="https://www.myzeon.com/blog/how-to-calculate-your-business-loan-emi-at-lower-rates" class="btn btn-primary mt-auto">Read More</a>
      </div>
    </div>
    ...
    <div class="card custom-card" style="width: 30rem; flex: 1; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); margin-right: 20px;">
      ...
      <div class="card-body d-flex flex-column">
        <h5 class="card-title"><a href="https://www.myzeon.com/blog/how-to-apply-for-personal-loan-online-in-5-easy-steps">How To Apply For Personal Loan Online In 5 Easy Steps?</a></h5>
        <p class="card-text">Are you looking to apply for a personal loan online? Why make multiple trips to the bank when you can apply for it from the comfort of your home?</p>
        <a href="https://www.myzeon.com/blog/how-to-apply-for-personal-loan-online-in-5-easy-steps" class="btn btn-primary mt-auto">Read More</a>
      </div>
    </div>
    ...
    <div class="card custom-card" style="width: 30rem; flex: 1; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); margin-right: 20px;">
      ...
      <div class="card-body d-flex flex-column">
        <h5 class="card-title"><a href="https://www.myzeon.com/blog/apply-for-business-loan-documents-you-need-for-business-loan">Apply for Business Loan: Documents You Need for Business Loan</a></h5>
        <p class="card-text">Are you looking for a business loan at lower interest rates? Do you want that financial boost for your company to reach new heights?</p>
        <a href="https://www.myzeon.com/blog/apply-for-business-loan-documents-you-need-for-business-loan" class="btn btn-primary mt-auto">Read More</a>
      </div>
    </div>

    <div class="card custom-card" style="width: 30rem; flex: 1; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      <img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/blog_img/blog4.png" class="card-img-top" alt="...">
      <div class="card-body d-flex flex-column">
        <h5 class="card-title"><a href="https://www.myzeon.com/blog/how-to-calculate-cibil-score-for-free">How to Calculate CIBIL Score for Free?</a></h5>
        <p class="card-text">Are you aware of what a CIBIL score is? What is the role of the CIBIL score when you are applying for a loan?</p>
        <a href="https://www.myzeon.com/blog/how-to-calculate-cibil-score-for-free" class="btn btn-primary mt-auto">Read More</a>
      </div>
    </div>
