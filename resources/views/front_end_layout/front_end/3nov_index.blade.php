...
<section class="main-slider-area mt-5">
	<div class="active-main-slider owl-carousel">
		...
		<div class="main-slider-item img-fluid " style="background-image: url({{ asset('assets/images/web_img/'.$value->image)}});" >
							...
							<div class="main-slider-welcome-text slidertwo sliderthree">
								...
								<h2 class="main-title" data-animation-in="fadeInLeft" data-animation-out="animate-out fadeOutLeft"><?php echo $value->title2;?></h2>
									...
									<div class="welcome-button" data-animation-in="fadeInDown" data-animation-out="animate-out fadeOutDown">
										<a href="<?php echo $value->url_1;?>" class="btn btn-default button-primary">Apply Now</a>
										<a href="<?php echo $value->url_2;?>" class="button-secondary btn btn-default">Contact Us</a>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="row gy-5 gx-5 mb-5">
            <div class="owl-carousel owl-theme sec-section">
               <?php foreach (getService() as $key => $value) {?>  
                <div class="item">
                    <div class="single-block h-100 d-flex flex-column justify-content-center  p-3">
...
<section class="pt-5 pb-5 bg-theme-blue">
	<div class="container">
			<div class="row">
				...
				<div class="col-md-12">
					<a href="https://www.myzeon.com/contact"><img src="{{asset('assets/front_end/asset/img/bg-why-myzeon.png')}}" class="img-fluid"></a>
				</div>
			</div>
	</div>
</section>
