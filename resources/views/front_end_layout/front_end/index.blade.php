                    ...
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }} innerBannerDiv">
                        ...
                        <div class="carousel-caption text-start mb-4">
                            ...
                            <div class="welcome-button applyBtnDiv" data-animation-in="animate-in"
                                ...
                                <a href="{{ $value2->url_1 }}" class="btn btn-primary btn-apply animated"
                                                                        ...
                                                                        <div class="btn-group btn-group-toggle add-check"
                                                                            ...
                                                                            <label class="btn btn-secondary">
                                                                                <input type=radio name=emischeme
                                                                                    ...
                                                                                    tabindex=4 autocomplete=off>EMI in
                                                                                Advance </label>
                                                                            <label class="btn btn-secondary active">
                                                                                <input type=radio name=emischeme
                        ...
                        <div class="col-lg-5 emiCalculatorDiv">
                            <div>
                                <div class="section-title text-center col-md-8">
                                    <h2 style="color: #1338be; ">EMI CALCULATOR</h2>
                                    <hr class="custom-divider">
                                    <p style="color: black; text-align: justify; font-weight: 600; ">EMI calculator is a
                                        financial tool to help you calculate your loan EMIs in advance. Fill out the desired
                                        loan term, tenure, and interest rate to calculate your EMI in just a click.
                                    </p>
                                </div>
                                <div class="section-title text-center col-md-8">
                                    <h4 style="color: #1338be;  padding: 2px;"><b>Personal Loan EMI Calculator</b></h4>
                                    <p style="color: black; text-align: justify;font-weight: 600; ">Have you ever found
                                        yourself in a tough spot due to an unexpected financial crisis? Use a personal loan
                                        calculator to get the exact monthly payments of a personal loan.
                                    </p>
                                </div>
                                <div class="section-title text-center col-md-8">
                                    <h4 style="color: #1338be; padding: 2px;"><b>Car Loan EMI Calculator</b></h4>
                                    <p style="color: black; text-align: justify;font-weight: 600;">Want your dream car but
                                        don't know how to do financial planning for it? Use the car loan EMI calculator to
                                        get accurate monthly payments for a car loan.
                                    </p>
                                </div>
                            </div>
                        </div>
