...
@section('content')
    ...
    <section id="sectionForMessage" class="jumbotron my-8" style="background-color: white;">
        <div class="row personaloan-header" style="height:350px;">
            ...
            <div class="col-md-8 ">
                ...
                <h6 class="font-family-merriweather text-base leading-6 headingdescription">
        ...
        <p style="color: red" class="font-family-playfair-display text-4xl font-bold text-center">Compare and Apply
            Instantly
    ...
    <section class="banner-img jumbotron sectiontable" style="background-color: white;margin-top:0px">
        <div class="container-fluid">
            ...
            <h1 class="text-center text-bg-primary">Know About More Loans</h1>
            <p style="color:black">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="heading-title">
                        <h5 class="mb-2 font-weight-bold text-dark f-17">Eligibility Criteria for Personal Loan</h5>
