        ...
        <div class="row personaloan-header" style="height:350px;">
            ...
            <div class="col-md-4">
                <img class="personalLoanImage"
                    src="{{ asset('assets/front_end/asset/img/bankLogo/persoal_loan_main_banner.png') }}"
            ...
            <div class="col-md-8 ">
                ...
                <h6 class="font-family-merriweather text-base leading-6 headingdescription" style="color: black;">
                            ...
                            <section id="startYourJourney">
                                ...
                                <div x-data="{
                                    ...
                                    <template x-if="count === 3">
                                        <div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Select Your Yearly Income </label>

                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="yearlyIncome0"
                                                        name="yearlyIncome" value="0-25000" x-model="yearlyIncome" />
                                                    <label for="yearlyIncome0" class="form-check-label">Upto ₹3
                                                        Lacs</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="yearlyIncome1"
                                                        name="yearlyIncome" value="25001-50000" x-model="yearlyIncome" />
                                                    <label for="yearlyIncome1" class="form-check-label">₹3 - ₹4
                                                        Lacs</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="yearlyIncome2"
                                                        name="yearlyIncome" value="50001-100000"
                                                        x-model="yearlyIncome" />
                                                    <label for="yearlyIncome2" class="form-check-label">₹4 - ₹5
                                                        Lacs</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="yearlyIncome3"
                                                        name="yearlyIncome" value="100001+" x-model="yearlyIncome" />
                                                    <label for="yearlyIncome3" class="form-check-label">₹5 - ₹10
                                                        Lacs</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="yearlyIncome3"
                                                        name="yearlyIncome" value="100001+" x-model="yearlyIncome" />
                                                    <label for="yearlyIncome3" class="form-check-label">₹10 Lacs +</label>
                                                </div>
             ...
             <div class="row">
                <div class="container mx-auto px-4 relative">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <button class="custom-button hover:bg-blue-800 text-white font-bold h-12 md:h-16 w-48 md:w-64 max-w-full text-base md:text-lg lg:text-xl rounded-full">
    <a href="http://192.168.120.228/myzeon_web/index.php/apply-new" style="color: white; text-decoration: none; display: block; height: 100%;">Apply Now</a>
</button>
