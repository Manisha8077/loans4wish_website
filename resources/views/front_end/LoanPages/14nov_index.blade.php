...
<div id=loanformcontainer class=row style="width: 642px;">
...
<li id=car-loan style="width: 138px;">
<a href=#>Car Loan</a>
</li>
</ul>
...
<div class="section-title text-center">
<h2 style="color: #1338be; text-align: center;">EMI CALCULATOR</h2>
<P style="color: black; text-align: center;font-weight: 600; ">EMI calculator is a financial tool to help you calculate your loan EMIs in advance. Fill out the desired loan term, tenure, and interest rate to calculate your EMI in just a click. 
</P>
</div>
<!-- <h2 style="color: black; text-align: center;margin-top: 94px;"><b>EMI Calculator</b></h2> -->
<div><h4 style="color: #1338be; text-align: center; padding: 2px;"><b>Personal Loan EMI Calculator</b></h4>
<p style="color: black; text-align: center;font-weight: 600; ">Have you ever found yourself in a tough spot due to an unexpected financial crisis? Use a personal loan calculator to get the exact monthly payments of a personal loan.
</p></div>
<div><h4 style="color: #1338be; text-align: center;padding: 2px;"><b>Car Loan EMI Calculator</b></h4>
<p style="color: black; text-align: center;font-weight: 600;">Want your dream car but don't know how to do financial planning for it? Use the car loan EMI calculator to get accurate monthly payments for a car loan. 
</p>
</div>
</div>
</div>
    ...
    <div class="row process-list">
      <div class="col-md-3 second-process">
          <div class="second-single-loan-process">
            <h4>Choose Amount</h4>
            <div class="icon" style="font-size: 30px;color: rgb(235, 155, 8);">
              <!-- Indian Rupee symbol -->
              ₹
            </div>
          </div>
      ...
      <div class="col-md-3 second-process">
        <div class="second-single-loan-process">
          ...
          <div class="icon">
            ...
            <i class="fas fa-thumbs-up" style="font-size: 30px; color: #1338BE;"></i>
          </div>
        </div>
      </div>
      <div class="col-md-3 second-process">
        <div class="second-single-loan-process">
          ...
          <div class="icon">
            ...
            <i class="fas fa-money-bill-wave" style="font-size: 30px;color: green;"></i>
          </div>
        </div>
      </div>
    </div>
...
<div class="card" style="width: 30rem;">
  <img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/persoal_loan_main_banner.png"   class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">How To Calculate Your Business Loan EMI At Lower Rates?</h5>
...
<div class="card" style="width: 30rem;">
  <img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/persoal_loan_main_banner.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">How To Apply For Personal Loan Online In 5 Easy Steps?</h5>
    <p class="card-text">Are you looking for apply a personal loan online? Why make multiple trips to the bank when you can apply for it from the comfort of your home? </p>
...
<div class="card" style="width: 30rem;">
  <img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/persoal_loan_main_banner.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Apply for Business Loan: Documents You Need for Business Loan</h5>
...
<div class="card" style="width: 30rem;">
  <img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/persoal_loan_main_banner.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">How to Calculate CIBIL Score for Free?</h5>
    <p class="card-text">Are you aware of what is CIBIL score? What is the role of the CIBIL score when you are applying for a loan? </p>
    <a href="#" class="btn btn-primary">Read More</a>
  </div>
</div><br>
