...
<body>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-info" data-dismiss="modal" id="btnModalClose">Close</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <select title="Select your employment" class="form-control" id="employee_type"
                                name="employee_type" data-validation="required" data-validation-error-msg=""
                        ...
                        <div class="form-group col-sm-4" id="selfEmployedBusinessFields" style="display:none ;">
                        ...
                        <div class="form-group col-sm-4" id="selfEmployedProfessionalFields" style="display:none ;">
                            <label>Profession</label>
                            <input type="text" class="form-control" name="profession" tabindex="6"
                                autocomplete="Off" placeholder="Enter Profession" id="profession">
                        </div>
                        ...
                        <div class="form-group col-sm-4 has-error" id="annual-turnover" style="display: block;">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon"></span>
                                <select title="Select Turnover" class="form-control" name="yearly_income"
                                    id="yearly_income" data-validation="required"
                        ...
                        <div class="form-group col-sm-4" id="year-in-business" style="display: ;">
                            ...
                            <input type="number" class="form-control" name="years_in_business" tabindex="9"
                                autocomplete="Off" placeholder="Years In Current Business/Profession" id="years_in_business">
                        </div>

                        <!-- Residence Type field -->
                        <div class="form-group col-sm-4" name="registance_type"
                            style="display: ;">
                            <label>Residence Type</label>
                            <select class="form-control" name="registance_type"  id="registance_type" required>
    ...
    <script>
        ...
        function handle_loan_application_form_submission() {
            ...
            const years_in_business = $('#years_in_business').val().trim();
            const residence_type = $('#registance_type').val().trim();

            console.log("years in profession"+years_in_business);
            ...
            if (phone_no === '' || employee_type === '' || yearly_income === '' ||
                ...
                $.ajax({
                    url: '<?php  echo website_api_base_url();?>/wp-bl-post',
                    method: 'POST',
                    data: {
                        ...
                        year_in_bussiness:years_in_business?years_in_business:'not selected',
                        registance_type:residence_type?residence_type:'not selected',
                    },
