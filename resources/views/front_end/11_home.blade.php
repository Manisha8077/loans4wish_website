...
<body class="js">
    ...
    <header class="navbar navbar-expand-lg navbar-light " style="background-color: #1338BE;">
        <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-lg navbar-light container-fluid">
                <a class="navbar-brand" href="http://192.168.120.228/myzeon_web/index.php" style="margin-left: 3px;">
          ...
          <img src="path/to/your/logo.png" alt="Company Logo" height="30">
      </a> -->
                ...
                <div class="collapse" id="navbarToggleExternalContent">
                 <ul class="navbar-nav ml-auto navBarItemButton d-flex justify-content-between">
                        <li class="nav-item headerMainContentButton"><a class="btn btn-primary text-yellow-500 font-bold text-2xl"
                                href="#showpanel" id="showAllloans"><b>ALL SERVICES</b></a></li>
                        <li class="nav-item headerMainContentButton"><a class="btn btn-primary text-yellow-500 font-bold text-2xl"
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav d-flex">
                        <li class="nav-item headerMainContentButton">
                            <a class="btn btn-primary text-yellow-500 font-bold text-2xl" href="http://192.168.120.228/myzeon_web/index.php/apply-new">APPLY NOW</a>
                            {{-- <a class="nav-link btn btn-primary text-yellow-500 font-bold text-2xl" href="#" >Apply Now</a> --}}
                        </li>
                        <li class="nav-item headerMainContentButton">
                            {{-- <a class="btn bnt-primary text-yellow-500 font-bold text-2xl" href="#">CIBIL Score</a> --}}
                            <a class="btn btn-primary text-yellow-500 font-bold text-2xl" href="https://www.myzeon.com/cibil-score-check">CIBIL
                                SCORE</a>
                        </li>
                    </ul>
                </div>
  ...
  <div id="showpanel" class="hidden bg-gradient-to-r from-blue-500 to-yellow-500 p-6 fade-in text-center" style="margin-top: 100px;">
