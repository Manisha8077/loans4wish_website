...
<style>
  ...
  border-top: 6px solid #007bff; /* Change the color as needed */
  border-radius: 50%;
  width: 50px;
  height: 50px;
...
{{-- <script>$(document).ready(function () {
  $('#personal-loan-button').click(function () {
    ...
    $('#personal-loan-button').css('display', 'none');

    // Submit the form after a brief delay to allow the spinner to show
    // setTimeout(function () {
 ...
 <section class="banner-img">
  <div class="container-fluid">
    ...
    z-index: 1;
    color: #fff; background-repeat: no-repeat;  object-fit: cover;">
    ...
    <div class="row gy-5 gx-5 mb-5">
          ...
          <form method="post" enctype="multipart/form-data"  id="personal-loan">
             @csrf
             @method('POST')
          <div class="row">
             <div class="col-md-12">
          ...
          <div class="row hidediv pl-3 pr-3" id="showdiv" style="">  
            <div class="col-md-12">
              <p class="mb-2">
                <b>Just fill a few more details to get quote...</b><form
              </p>
            </div>
            <div class="col-md-6">
              <div class="form-group">
