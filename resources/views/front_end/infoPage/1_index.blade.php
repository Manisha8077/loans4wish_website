        ...
        <div class="carousel-inner outerBannerDiv">
            ...
            <div class="carousel-item {{ $key == 0 ? 'active' : '' }} innerBannerDiv">
                ...
                <div class="carousel-caption text-start mb-4">
                    ...
                    <div class="welcome-button applyBtnDiv" data-animation-in="animate-in"
                        data-animation-out="animate-out">
                        <a href="{{ $value2->url_1 }}" class="btn btn-primary btn-apply animated" id="apply-now">Apply
                            Now</a>
                        <a href="{{ $value2->url_2 }}" class="btn btn-primary btn-apply animated"
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="section-title text-center col-md-6" style="top: 45px;">
                    <h2 style="color: #1338BE;  text-align: justify; text-align: center;">EMI CALCULATOR</h2>
                    ...
                    <div class="section-title text-center">
                        <h4 style="color: #ffd756; text-align: justify; padding: 2px; text-align: center;"><b>Personal Loan EMI
                                Calculator</b></h4>
                    ...
                    <div class="section-title text-center">
                        <h4 style="color: #ffd756; text-align: justify;padding: 2px; text-align: center;"><b>Car Loan EMI Calculator</b>
                        </h4>
                            ...
                            <div class="card h-100" style="width: 21rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="https://www.myzeon.com/blog/how-to-calculate-your-business-loan-emi-at-lower-rates"
                                        class="btn btn-primary blogButton1">Read More</a>
                                </div>
                            </div>
                        </div>
