        ...
        @foreach(getSlider() as $key => $value2)
          <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
            ...
            <div class="carousel-caption text-start mb-4">
              <div>
                <h2 class="main-title" data-animation-in="fadeInLeft" data-animation-out="animate-out fadeOutLeft">{!! $value2->title2 !!}</h2>
...
<section class="loan-calculator-page section-padding  pb-5" id="calculator-emi">
  ...
  <div class="col-lg-5 emiCalculatorDiv" style="margin-top: 48px;">
    <div>
    ...
    <div class="section-title text-center col-md-8"><h4 style="color: #1338be; text-align: justify; padding: 2px;"><b>Personal Loan EMI Calculator</b></h4>
    ...
    <div class="section-title text-center col-md-8"><h4 style="color: #1338be; text-align: justify;padding: 2px;"><b>Car Loan EMI Calculator</b></h4>
