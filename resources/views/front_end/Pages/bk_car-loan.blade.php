...
if (currentIndex === 1) {
    ...
    console.log(phoneNumber + " hello jquery");

    // Ajax request
   
    $.ajax({
                        url: 'http://192.168.120.228/myzeon_web/index.php/api/apply-for-detail/'+phoneNumber, // Replace with your server endpoint
...
<!-- <script>
    function validateAndProceed() {
        ...
        if (!agreeCheckbox) {
            ...
            errorContainer.innerHTML = '<p style="color: red;">Please agree to proceed with the provided mobile number.</p>';
            return;
        }
...
<!-- 108 -->
    <div id="divBanner">
        ...
        <div class="form-group" >
            ...
            <label for="agreeCheckbox" style="font-size: 12px;" >I agree to the terms and conditions</label>
        </div>
                ...
                <div class="step-tab-panel" data-step="step2" id="divstep1">
                    ...
                    <form name="frmContact" id="frmContact" class="form-group label">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="city">City <span style="color: red;">*</span></label><span id="error_city"></span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="state">State <span style="color: red;">*</span></label><span id="error_state"></span>
                                    <input type="text" readonly style="background-color: white;" class="form-control"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="propertyFinalizedYes" name="propertyFinalized" value="Yes" >
                                        <label class="form-check-label" for="propertyFinalizedYes">Yes</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="propertyFinalizedNo" name="propertyFinalized" value="No" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                <label for="currentBank">Current Bank Name <span style="color: red;">*</span></label>
                            ...
                            <select id="loanType" name="loanType" class="form-control" required>
                                ...
                                <div class="form-group">
                                    <label for="primaryBank">Primary Bank Account <span style="color: red;">*</span></label>
                                    <input type="text" id="primaryBank" name="primaryBank" class="form-control" required>
                                    </div>
                            </div>
                            </div>
