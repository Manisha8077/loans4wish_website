...
@push('indexPageScript')
    ...
    <script>
        ...
        function saveChanges() {
            ...
            $.ajax({
                url: "<?php echo website_base_url();?>/api/pop-up-post",
...
@section('content')
    ...
    <!-- <section class="mainslider" style="margin-top: 82px;"> -->
    <section class="mainslider" style="margin-top: 82px;">
                ...
                @foreach (getSlider() as $key => $value2)
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }} innerBannerDiv">
                        ...
                        <div class="carousel-caption text-start mb-4">
                            ...
                            <!-- <div class="" data-animation-in="animate-in"
                            data-animation-out="animate-out"> -->
                            <div class="" data-animation-in="" data-animation-out="">
                                <a href="{{ $value2->url_1 }}" class="btn btn-primary " id="apply-now">Apply
                                    Now</a>
                                <a href="{{ $value2->url_2 }}" class="btn btn-primary " id="contact-us">Contact Us</a>
                            </div>
                    ...
                    <div class="item">
                        <div class="single-block d-flex flex-column justify-content-center p-3" id="head">
                            ...
                            <div class="overlaye-bg" style="background-color: #1338be;">
                                <a href="<?php echo $value->apply_url; ?>" class="apply-btn" style="color: #ffd756;">Apply
                                    Now</a>
                                <a href="<?php echo $value->compare_url; ?>" class="apply" style="color: #ffd756;">Quick
                                    Compare</a>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="row">
                                    ...
                                    <div id=loanformcontainer class=row>
                                        ...
                                        <div id=emicalculatordashboard class=col-md-8>
                                            ...
                                            <ul class=loanproduct-nav>
                                                <li id=home-loan class="list-group-item">
                                                    <a href=#>Home Loan</a>
                                                </li>
                                                <li id=personal-loan class="list-group-item">
                                                    <a href=# style="white-space:no-wrap;">Personal Loan</a>
                                                </li>
                                                <li id=car-loan class="list-group-item">
                                                    <a href=#>Car Loan</a>
                                                </li>
                                            </ul>
                    ...
                    <div class="section-title text-center col-md-6" style="top: 45px;">
                        ...
                        <div class="section-title text-center">
                            <h4 style="color: #ffd756; text-align: justify; padding: 2px; text-align: center;"><b>Personal
                                    Loan EMI
                                    Calculator</b></h4>
                        ...
                        <div class="section-title text-center">
                            <h4 style="color: #ffd756; text-align: justify;padding: 2px; text-align: center;"><b>Car Loan
                                    EMI Calculator</b>
                            </h4>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card text-center custom-card">
                    <i class="fa-solid fa-sack-dollar card-icon custom-icon"
    ...
    <hr class="custom-divider"> -->
            ...
            <div class="col-sm-3">
                <div class="card card-block">
                    ...
                    <div class="card-block">
                        ...
                        <p class="card-text paraFont">Are you looking to apply for a personal loan online? </p>
                        <div class="blogBtn"><a
        ...
        <!-- <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 p-5 jumbotron">

                        <div class="row  gx-5 mb-5">

                            <div class="col-md-3 ">
                                <div class="card h-100" style="width: 21rem;">
                                    <img src="http://192.168.120.228/myzeon_web/assets/images/web_img/Loan_emi.png"
                                        class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title heading-card"><a
                                                href="https://www.myzeon.com/blog/how-to-calculate-your-business-loan-emi-at-lower-rates">How
                                                To Calculate Your Business Loan EMI At Lower Rates?</a></h5>
                                        <p class="card-text">
                                            {{ Str::limit(
                                                'Planning to start a business but worried about funds? Are you looking for a
                                                                                    business loan?',
                                                150,
                                            ) }}
                                        </p>
                                        <a href="https://www.myzeon.com/blog/how-to-calculate-your-business-loan-emi-at-lower-rates"
                                            class="btn btn-primary blogButton1" style="margin-top: 20px;">Read More</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 ">
                                <div class="card h-100" style="width: 21rem;">
                                    <img src="http://192.168.120.228/myzeon_web/assets/images/web_img/apply_for.png"
                                        class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title heading-card"><a
                                                href="https://www.myzeon.com/blog/how-to-apply-for-personal-loan-online-in-5-easy-steps">How
                                        ...
                                        <p class="card-text">
                                            {{ Str::limit(
                                                "Are you looking to apply for a personal loan online? Why make multiple trips to
                                                                                    the bank ?
                                                                                    This article will help you understand the Home Loan and how it can help you buy
                                                                                    a house.",
                                                150,
                                            ) }}
                                        </p>
                                        <a href="https://www.myzeon.com/blog/how-to-apply-for-personal-loan-online-in-5-easy-steps"
                                            class="btn btn-primary blogButton">Read More</a>
                            ...
                            <div class="col-md-3 ">
                                <div class="card h-100" style="width: 21rem;">
                                    <img src="http://192.168.120.228/myzeon_web/assets/images/web_img/documents_require.png"
                                        class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title heading-card"><a
                                                href="https://www.myzeon.com/blog/apply-for-business-loan-documents-you-need-for-business-loan">Apply
                                        ...
                                        <p class="card-text">
                                            {{ Str::limit(
                                                'Are you looking for a business loan at lower interest rates? Do you want that
                                                                                    financial boost?',
                                                150,
                                            ) }}
                                        </p>
                                        <a href="https://www.myzeon.com/blog/apply-for-business-loan-documents-you-need-for-business-loan"
                            ...
                            <div class="col-md-3 ">
                                <div class="card h-100" style="width: 21rem;">
                                    <img src="http://192.168.120.228/myzeon_web/assets/images/web_img/calculate_cibil.png"
                                        class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title heading-card"><a
                                                href="https://www.myzeon.com/blog/how-to-calculate-cibil-score-for-free">How
                                                to Calculate CIBIL Score for Free?</a></h5>
                                        <p class="card-text">
                                            {{ Str::limit(
                                                'Are you aware of what a CIBIL score is? What is the role of the CIBIL score
                                                                                    when you are applying for a loan?',
                                                150,
                                            ) }}
                                        </p>
                                        <a href="https://www.myzeon.com/blog/how-to-calculate-cibil-score-for-free"
                                            class="btn btn-primary blogButton">Read More</a>
                    ...
                    <form id="namePhoneForm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Enter your name"
                                style="  background-color: #80808026;">
                        </div>
                        <div class="form-group">
                            <label for="phone" style="font-size: 17px; color: black;">Phone Number:</label>
                            <input type="tel" class="form-control" id="phone"
                                placeholder="Enter your phone number" style="  background-color: #80808026;">
                        </div>
                    </form>
                </div>
