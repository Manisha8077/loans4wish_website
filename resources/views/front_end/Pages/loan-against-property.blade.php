...
function timer(remaining) {
            ...
            onChange: function(currentIndex, newIndex, stepDirection) {
               ...
               if (currentIndex === 0 && newIndex === 1 && stepDirection === 'forward') {
                ...
                if (currentIndex === 3) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{website_api_base_url()}}/property-loan-apply",
                        data: formDataObject,
                        success: function(response) {
                            $(".spinner").hide();
                            console.log(response);
    ...
    <script>
        $("#btnModalClose").on('click', function() {
            // $("#modal").hide();
            $('#myModal').modal('hide');
            window.location.href = "{{website_base_url()}}//loan-against-property";
...
@section('content')
    <div class="">
        ...
        <img class="card-img" src="{{website_asset_base_url()}}/images/web_img/loan_against_pro.jpeg"
