...
function timer(remaining) {
        ...
        $('#demo').steps({
            onChange: function(currentIndex, newIndex, stepDirection) {
                ...
                if (currentIndex === 3) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{website_api_base_url()}}/car-loan-apply",
                        data: formDataObject,
                        success: function(response) {
                            console.log(response);
    ...
    <script>
        $("#btnModalClose").on('click', function() {
            // $("#modal").hide();
            $('#myModal').modal('hide');
            window.location.href = "{{website_base_url()}}/car-loan";
...
@section('content')
    <div class="">
        ...
        <img class="card-img" src="{{website_asset_image_webimage_base_url()}}/car_loan.jpeg" alt="Card image"
            width="auto"  />
    </div>
            ...
            <div class="mt-4">
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <p class="paraFont">
                        Car loans provide different options to repay your loan. Some of the repayment options are
