...
@push('startyourjourneyscript')
    ...
    <script>
        ...
        function submitOtpVerification() {
            ...
            try {
                $.ajax({
                    url: `{{crm_base_url()}}/cibil-submit-otp/${mobileNumber}/${otp}`,
                    type: 'GET',
                    headers: {
                    ...
                    success: function(response) {
                        ...
                        window.setCheckOtpStatusforCibil = true;
                    ...
                    error: function(jqXHR, textStatus, errorThrown) {
                        ...
                        window.setCheckOtpStatusforCibil = false;
                        // Handle error here
                    }
                });
            } catch (error) {
        ...
        $(document).ready(function() {
            ...
            function showCibilScore(mobilenumber) {
                ...
                $.ajax({
                    url: "{{crm_base_url()}}/check-cibil-score/" + mobile,
                    type: "GET",
                    success: function(response) {
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            window.setCookesOtpSubmmision = false;
            window.setCheckOtpStatusforCibil =false //for checking otp submit 
        });
        //108
        ...
        $('#demo').steps({
            onChange: function(currentIndex, newIndex, stepDirection) {
                ...
                if (currentIndex === 2 && newIndex === 3 && stepDirection === 'forward') {

                    if(setCheckOtpStatusforCibil===false){
                        return false;
                    }
                ...
                //  if(currentIndex == 3 &&  newIndex == 3 && stepDirection = forward) {
                ...
                if (currentIndex === 3 && newIndex === 3 && stepDirection === 'none') {
                    ...
                    $.ajax({
                        url: `{{crm_base_url()}}/cibil-profile/${number}`,
                        type: 'GET',
                        dataType: 'json',
                        success: function(profileResponse) {
                            console.log('Profile API call on page load successful:',
                                profileResponse[0].email);
                        ...
                        error: function(profileXhr, profileStatus, profileError) {
                            console.error('Profile API call on page load failed:', profileXhr,
                ...
                if (currentIndex === 4) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "{{ website_base_url() }}/api/cibil-insert-reg",
                        data: formDataObject,
                        success: function(response) {
                            console.log(response);
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('#dob').on('change', function() {
                ...
                console.log("date piecker clicked");
                var dobInput = $(this).val();
                console.log("date piecker clicked 2" + dobInput);
...
@section('content')
    <div class="">
        ...
        <img class="card-img" src="{{ website_asset_image_webimage_base_url() }}/cibil_image.png" alt="Card image"
            width="auto"  />
    </div>
                    ...
                    <div class="step-tab-panel" data-step="step2">
                        ...
                        <form name="frmContact" id="frmContact" class="form-group label">
                            ...
                            <div class="step-footer mt-5" id="divbtn">
                                <!-- <button data-step-action="prev" class="step-btn btn btn-success">Previous</button> -->
                                <button data-step-action="next" class="step-btn btn btn-success"
                                    onclick="copyMobileNumber()" id="btnNext">Next</button>
                                <!-- <button data-step-action="finish" class="step-btn btn btn-success" type="submit">Finish</button> -->
                            </div>
                    ...
                    <div class="step-tab-panel" data-step="step3">
                        ...
                        <form name="frmIncome" id="frmIncome" class="form-group label">
                            ...
                            <div class="step-footer mt-5">
                                ...
                                <button data-step-action="next" class="step-btn btn btn-success"
                                    onclick="submitOtpVerification()">Next</button>
                    ...
                    <div class="step-tab-panel" data-step="step4">
                        ...
                        <form name="frmIncome2" id="frmIncome2" class="form-group label">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="container">
                                        <h2 class="mt-5 text-center" style="font-size:28px; color: #000;"> Credit Score
                                            Meter</h2>
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="scoreMeterContainer">
                                                <div class="scoreMeter">
                                                    <img src="{{ website_asset_image_base_url() }}/img/meter-CIBIL.png"
                                                        alt="Score Meter" width="500" height="200">
                                                    <div class="meterArrow" data-deg="0"></div>
                                                    <div class="meterScore">
                                                        <div class="score" id="scorevalue" style="color: #444840;">
                                                            &nbsp;No
                                                            score.</div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="container mb-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4"><label class="form-label"
                                                                ...
                                                                <input id="inpMiddleName" class="form-control"
                                                                    type="text" placeholder="Enter Middle Name ">
                                                            </div>
                                                            <div class="col-md-4"><label class="form-label"
                                                                    for="name">Last
                                                                    Name</label><span id="error_last_name"></span>
                                                                <input id="inpLastName" class="form-control"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4"><label
                                                                    for="pancard">Pancard</label><span
                                                                    id="error_pancard"></span>
                                                                <input id="inpPancard" class="form-control"
                                                            ...
                                                            <div class="col-md-4"><label for="mobile">Mobile
                                                                ...
                                                                <input id="inpmobilenumber" class="form-control"
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="flush-collapseThree" class="accordion-collapse collapse"
                                                ...
                                                <div id="elementor-tab-content-1883"
                                                    ...
                                                    aria-labelledby="elementor-tab-title-1883" style="display: block;">
                        ...
                        <form name="frmIncome1" id="frmIncome1" class="form-group label">
                            ...
                            <div id="banner">
                                ...
                                <button class="btn btn-primary" id="applyAgain"
                                    style="display: block; margin: auto;">Apply
                                    Again</button>
                            </div>
                            <!-- <div class="step-footer mt-5">
                                    <button data-step-action="prev" class="step-btn btn btn-success">Previous</button>
    ...
    <section class="container-fluid" style="line-height: 1.8;">
        <div class="container-fluid mt-4">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnNext').click(function() {
                ...
                // Make an API call
                $.ajax({
                    url: '{{crm_base_url()}}/cibil-insert-reg',
