...
@push('startyourjourneystyle')
    ...
    <link href="{{ asset('assets/css/pagecss/plcommon.css') }}" rel="stylesheet">
...
@push('personalLoanStyle')
    <!-- /var/www/html/myzeon_web/assets/front_end/asset/css/newcss  {{ asset('assets/front_end/asset/startjourney/css/style.css') }} -->
    <link rel="stylesheet" href="{{ asset('assets/front_end/asset/css/newcss/jquery-steps.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/front_end/asset/css/newcss/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/front_end/asset/css/newcss/owl.theme.default.min.css') }}">
    ...
    <div class="container-fluid mt-4">
        <div>
            ...
            <p class="paraFont">The necessary documentation for <a
                    href="https://www.myzeon.com/blog/how-to-apply-for-personal-loan-online-in-5-easy-steps">easy steps for
                    an online personal loan</a> is very important
                for lenders who require these documents to assess your eligibility and the value of credit. Get ready with
            ...
            <ul>
                ...
                <li class="paraFont ">
                    ...
                    Proof of Income (for salaried employees - payslip, a letter from your employer stating your income. For
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="yearlyIncome">Select Yearly Income <span
                                                style="color: red;">*</span></label>
                                        <select class="form-control" id="yearlyIncome" name="yearlyIncome" required>
                                            <option value="" disabled selected>Select</option>
        ...
        <div class="container-fluid mt-3 mb-4">
            ...
            <div class="row">
                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        <tr>
                            <td style="height: 60px;"><img
                                    src="{{ website_asset_image_base_url() }}/img/bankLogo/HDFC_bank.png" alt="Bank 1"
                                    style="width: 88px;
                    height: 23px; margin-top: 10px;"></td>
                            <td>HDFC Bank</td>
                            <td>10.25%</td>
                        </tr>
                        <tr>
                            <td><img src="{{ website_asset_image_base_url() }}/img/bankLogo/indusland_bank.jpg"
                                    alt="Bank 2" style="height: 46px;"></td>
                            <td>Indusland Bank</td>
                            <td>10.75%</td>
                        </tr>
                        <tr>
                            <td><img src="{{ website_asset_image_base_url() }}/img/bankLogo/standard_bank.jpg"
                                    alt="Bank 3" style="height: 42px;
                    width: 80px;"></td>
                            <td>Standard Bank</td>
                            <td>11.00%</td>
                        </tr>
                        <tr>
                            <td><img src="{{ website_asset_image_base_url() }}/img/bankLogo/axis_bank.png" alt="Bank 4"
                                    style="height: 36px;
                    width: 89px;"></td>
                            <td>Axis Bank </td>
                            <td>10.50%</td>
                    ...
                    width: 80px;"></td>
                        ...
                        <tr>
                            <td><img src="{{ website_asset_image_base_url() }}/img/bankLogo/icici_bank.jpg"
                                    alt="Bank 6" style="height: 43px;"></td>
                            <td> ICICI Bank </td>
                            <td>12.25%</td>
                        </tr>
                        <tr>
                            <td><img src="{{ website_asset_image_base_url() }}/img/bankLogo/idfc_bank.jpg" alt="Bank 7"
                                    style="height: 45px;
                    width: 87px;"></td>
                            <td> IDFC Bank </td>
                            <td>13.25%</td>
                        ...
                        <tr style="height: 60;">
                            <td><img src="{{ website_asset_image_base_url() }}/img/bankLogo/bajaj.png" alt="Bank 8"
                                    style="width: 23%;
                    height: 31px;"></td>
                        ...
                        <tr>
                            <td><img src="{{ website_asset_image_base_url() }}/img/bankLogo/yes_bank.jpg" alt="Bank 9"
                                    style="height: 44px;
                    width: 80px;"></td>
                            <td> Yes Bank </td>
                            <td>15.25%</td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="3"><span style="color: red; font-size: 15px;">*</span> The rate of interest
