...
<body class="js">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav d-flex">
                        <li class="nav-item headerMainContentButton">
                            ...
                            {{-- <a class="nav-link btn btn-primary text-yellow-500 font-bold text-2xl" href="#">Apply
                                Now</a> --}}
                        </li>
                        <li class="nav-item headerMainContentButton">
                            {{-- <a class="btn bnt-primary text-yellow-500 font-bold text-2xl" href="#">CIBIL Score</a>
                            --}}
                            <a class="btn btn-primary text-yellow-500 font-bold text-2xl"
                                href="https://www.myzeon.com/cibil-score-check">CIBIL
                                SCORE</a>
                        </li>
                    </ul>
                </div>
    ...
    <!-- <div class="container">
      <div class="row align-items-center" style="margin-top: 19px;">
          ...
          <div class="col-md-12 col-lg-12 col-xl-3 text-center text-md-right">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="my-form">
          ...
          <div style="text-align: center;"><button type="button" id="btnSubmit" class="btn btn-primary">Submit</button></div>
      </form>
    ...
    <!-- Add your loader and success message divs inside the modal -->
    ...
    <div id="showpanel" class="hidden bg-gray-100 p-6 fade-in text-center" style="margin-top: 100px;">
        <div class="flex-container justify-between space-x-4">
            ...
            <div class="flex-item animate__animated animate__fadeIn">
                <p class="text-xl font-semibold mb-4 blueText">LOANS</p>
            ...
            <div class="flex-item animate__animated animate__fadeIn">
                <p class="text-xl font-semibold blueText mb-4">CARDS</p>
                <ul class="ulText" style="text-align: left;">
                    <li>
            ...
            <div class="flex-item animate__animated animate__fadeIn">
                ...
                <p class="text-xl font-semibold blueText mb-4">INVESTMENTS</p>
            ...
            <div class="flex-item  animate__animated animate__fadeIn">
                ...
                <p class="text-xl font-semibold blueText mb-4">FINANCIAL TOOLS</p>

                <ul class="nav navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle hover:underline font-medium" href="#" id="showcalu" role="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            CALCULATOR
                        </a>
                        <div class="dropdown-menu" aria-labelledby="showcalu">
                            <a class="dropdown-item hover:underline font-medium" href="{{ route('cal-personal-loan') }}">Personal Loan</a>
                            <a class="dropdown-item hover:underline font-medium" href="{{ route('cal-business-loan') }}">Business Loan</a>
                            <a class="dropdown-item hover:underline font-medium" href="{{ route('cal-home-loan') }}">Home Loan</a>
                            <a class="dropdown-item hover:underline font-medium" href="{{ route('cal-car-loan') }}">Car Loan</a>
                            <a class="dropdown-item hover:underline font-medium" href="{{ route('gst-calculator') }}">GST Calculator</a>
                            <a class="dropdown-item hover:underline font-medium" href="{{ route('fd-calculator') }}">FD Calculator</a>
                            <a class="dropdown-item hover:underline font-medium" href="{{ route('ppf-deposit') }}">PPF Calculator</a>
                            <div class="dropdown-divider"></div>
                        </div>
                    </li>
                    
                </ul>
                <li style="list-style: none;"> <a href="http://192.168.120.228/myzeon_web/index.php/ifsc"
                    class="hover:underline font-medium" >IFSC CODE</a> </li>
            </div>
                            ...
                            <li class="mb-2">
                                <a href="https://goo.gl/maps/CPzMDB39QHEE4Kud9" target="_blank" rel="noopener"
                                    ...
                                    <i class="fa fa-home" aria-hidden="true"
                                        style="color: #ffd756; font-size: 17px;"></i>A-47, Sector-2 Noida,UP-201301
                                </a>
                            </li>
                            <li class="mb-2">
