    ...
    <div id="showpanel" class="hidden bg-gray-100 p-6 fade-in text-center" style="margin-top: 100px;">
        <div class="flex-container justify-between space-x-4">
            ...
            <div class="flex-item animate__animated animate__fadeIn">
                ...
                <p class="text-xl font-semibold blueText mb-4 mx-4">INVESTMENTS</p>
            ...
            <!-- FINANCIAL TOOLS -->
               ...
               <ul style="text-align: left;"><li><a href="{{ route('ifsc') }}" class="hover:underline font-medium">IFSC</a></li>
                <div>
                <a style = " cursor: pointer;" class="hover:underline font-medium" id= "anchorCal" onclick="CaluculatorFunction()">CALCULATOR<i class="fa-solid fa-caret-down"></i></a>
                <ul id="calList" class="ulText" >
                                                <li class="hover:underline font-medium">

                            <a href="{{ route('cal-personal-loan') }}"
                                class="dropdown-item">Personal Loan</a>
                        ...
                        <li class="hover:underline font-medium">
                            ...
                            <a href="{{ route('cal-business-loan') }}"
                                class="dropdown-item">Business Loan</a>

                        </li>

                        <li class="hover:underline font-medium">

                            <a href="{{ route('cal-home-loan') }}" class="dropdown-item">Home
                                Loan</a>
                        ...
                        <li class="hover:underline font-medium">
                            ...
                            <a href="{{ route('cal-car-loan') }}" class="dropdown-item">Car
                                Loan</a>
                        ...
                        <li class="hover:underline font-medium">
                            ...
                            <a href="{{ route('gst-calculator') }}" class="dropdown-item">GST
                                Calculator</a>
                        ...
                        <li class="hover:underline font-medium">
                            ...
                            <a href="{{ route('fd-calculator') }}" class="dropdown-item">FD
                                Calculator</a>
                        ...
                        <li class="hover:underline font-medium">
                            ...
                            <a href="{{ route('ppf-deposit') }}" class="dropdown-item">PPF
                                Calculator</a>
