...
<section class="banner-img">
  <div class="container-fluid">
    ...
    z-index: 1;
    color: #fff;">
         <h1 class="text-white text-center" style="z-index: 1;">Business Loan EMI Calculator</h1>
         <h5 class="text-white text-center"  style="z-index: 1;"> Speculate Business Loan EMIs Before Applying for Loan</h5>
      </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="heading-title">
          <h5 class="mb-2 font-weight-bold text-dark f-17">Business Loan EMI Calculator</h5>
          <div class="bar"></div>
        </div>
      </div>
        <div class="col-md-12">
          <p>Use the Business Loan EMI Calculator and speculate your EMI on a business loan. Check how Interest Rate and Loan Tenure affects your Business Loan EMI.
            Business Loans are essential to operate a successful business. Although there are many forms to raise capital, taking a business loan is the most common. However, many organizations are available to provide business loans in the market. As you know, business loans are very high to meet the necessary requirements for running a business. Hence, it is equally important to see the information regarding the EMI on the business loan amount beforehand. 
            Therefore, to provide proper guidance to potential customers who are taking a business loan, organizations and banks have built up Business Loan EMI Calculator. With the assistance of the same business loan EMI calculation, you will be able to plan a monthly budget to repay the loan amount as per your capability. As a matter of fact, defaulting on any loan has an adverse effect on your credit score and eligibility for a future loan. 
</p>
        </div>
      </div>
