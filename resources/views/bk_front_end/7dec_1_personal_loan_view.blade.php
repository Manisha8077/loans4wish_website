    ...
    <div class="row"> <!--row-start-->
        ...
        <div class="col-sm-12 pt-2" style="text-align: center;">
            <table class="table table-bordered border"
                style="border-collapse: collapse; width: 99.2586%; height: 156px;" border="1">
                <tbody>
                    <tr style="height: 26px;text-align: center;">
                        ...
                        <td style="width: 25%; height: 26px;"><strong style="text-align: justify;"><span
                                    style="font-size: 14pt; font-family: Poppins, sans-serif; color: #000000; background-color: transparent; font-style: normal; font-variant: normal; text-decoration: none; vertical-align: baseline; white-space: pre-wrap;">Rate
                                    of Interest <span style="color:red;">*</span> </span></strong></td>
                    ...
                    <tr style="height: 26px;">
                        <td style="width: 50%; height: 26px;">
                            <div class="bank-details">
                                <img class="bankLogo"
                                    src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/hdfc_bank.jpg"
                                    alt="HDFC Bank" loading="lazy">
                                <span class="bankName">HDFC Bank</span>
                            </div>
                        </td>
                        <td style="width: 25%; height: 26px;">
                            <span
                                style="color: #000000; font-family: Poppins, sans-serif; font-size: 17.3333px; text-align: justify; white-space-collapse: preserve;">10.25%</span>
                        </td>
                    </tr>
                    <!--  -->
                    ...
                    <tr style="height: 26px;">
                        <td style="width: 50%; height: 26px;">
                            <div class="bank-details">
                                <img class="bankLogo"
                                    src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/indusland_bank.jpg"
                                    alt="IndusInd Bank " loading="lazy">
                                <span class="bankName">IndusInd Bank </span>
                            </div>
                        </td>
                        <td style="width: 25%; height: 26px;">
                            <span
                                style="color: #000000; font-family: Poppins, sans-serif; font-size: 17.3333px; text-align: justify; white-space-collapse: preserve;">10.75%</span>
                        </td>
                    </tr>
                    <!--  -->
                    ...
                    <tr style="height: 26px;">
                        <td style="width: 50%; height: 26px;">
                            <div class="bank-details">
                                <img class="bankLogo"
                                    src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/standard_bank.jpg"
                                    alt="Standard Chartered Bank" loading="lazy">
                                <span class="bankName">Standard Chartered Bank</span>
                            </div>
                        </td>
                        <td style="width: 25%; height: 26px;">
                            <span
                    ...
                    <tr style="height: 26px;">
                        <td style="width: 50%; height: 26px;">
                            <div class="bank-details">
                                <img class="bankLogo"
                                    src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/axis_bank.png"
                                    alt="Axis Bank" loading="lazy">
                                <span class="bankName">Axis Bank</span>
                            </div>
                        </td>
                        <td style="width: 25%; height: 26px;">
                            <span
                                style="color: #000000; font-family: Poppins, sans-serif; font-size: 17.3333px; text-align: justify; white-space-collapse: preserve;">10.99%</span>
                        </td>
                    </tr>
                    <!--  -->
                    ...
                    <tr style="height: 26px;">
                        <td style="width: 50%; height: 26px;">
                            <div class="bank-details">
                                <img class="bankLogo"
                                    src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/kotak_bank.jpg"
                                    alt="Kotak Mahindra Bank" loading="lazy">
                                <span class="bankName">Kotak Mahindra Bank</span>
                            </div>
                        </td>
                        <td style="width: 25%; height: 26px;">
                            <span
                ...
                <tfoot>
                    <tr>
                        <td colspan="2"><span style="color: red; font-size: 15px;">*</span> The rate of interest
                            mentioned here may vary from time to time. To get the accurate and precise information on
