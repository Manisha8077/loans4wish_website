...
@section('content')
    ...
    <div class="">
        ...
        <img class="card-img" src="http://192.168.120.228/myzeon_web/assets/images/web_img/ifsc_banner.png" alt="Card image"
    ...
    <section class="">
        {{-- <div class="container-fluid mt-4">
            <div>
                <h4 class="eligible slide">What is IFSC Code?</h4>
                <div class="bar m-auto">&nbsp;</div><br><br>
                <p class="paraFont">
                    The Reserve Bank of India (RBI) assigns the IFSC codes to the bank. Apart from the cheque leaf,
                    you
                    can also find the IFSC code on the official website of the bank and the RBI.<br>

                    In case you are using net banking to transfer money, it is mandatory for the IFSC to be entered
                    to
                    initiate the transfer. Unless there is a merger, banks do not modify or change the IFSC code.
                </p>
