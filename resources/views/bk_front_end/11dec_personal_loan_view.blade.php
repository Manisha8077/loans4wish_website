...
<section class="jumbotron">
    ...
    <table class="table table-bordered ">
        ...
        <tbody>
            <tr>
                <td style="height: 60px;"><img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/HDFC_bank.png" alt="Bank 1" style="width: 88px;
                    height: 23px; margin-top: 10px;"></td>
                <td>HDFC Bank</td>
                <td>10.25%</td>
            </tr>
            <tr>
                <td><img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/indusland_bank.jpg" alt="Bank 2" style="height: 46px;"></td>
                <td>Indusland Bank</td>
                <td>10.75%</td>
            </tr>
            <tr>
                <td><img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/standard_bank.jpg" alt="Bank 3" style="height: 42px;
                    width: 80px;"></td>
                <td>Standard Bank</td>
                <td>11.00%</td>
            </tr>
            <tr>
                <td><img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/axis_bank.png" alt="Bank 4" style="height: 36px;
                    width: 89px;"></td>
                <td>Axis Bank </td>
                <td>10.50%</td>
            </tr>
            <tr>
                <td><img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/kotak_bank.jpg" alt="Bank 5" style="height: 44px;
                    width: 80px;"></td>
                <td> Kotak Mahindra Bank </td>
                <td>11.25%</td>
            </tr>
            <tr>
                <td><img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/icici_bank.jpg" alt="Bank 6" style="height: 43px;"></td>
                <td> ICICI Bank </td>
                <td>12.25%</td>
            </tr>
            <tr>
                <td><img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/idfc_bank.jpg" alt="Bank 7" style="height: 45px;
                    width: 87px;"></td>
                <td> IDFC Bank </td>
                <td>13.25%</td>
            </tr>
            <tr style="height: 60;">
                <td><img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/bajaj.png" alt="Bank 8" style="width: 23%;
                    height: 31px;"></td>
                <td> Bajaj Finserv Bank </td>
                <td>14.25%</td>
            </tr>
            <tr>
                <td><img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/yes_bank.jpg" alt="Bank 9" style="height: 44px;
                    width: 80px;"></td>
                <td> Yes Bank </td>
                <td>15.25%</td>
            </tr>
            <tr style="height: 60px;">
                <td><img src="http://192.168.120.228/myzeon_web/assets/front_end/asset/img/bankLogo/paysense_bank.jpeg" alt="Bank 10" style="width: 23%;
                    height: 32px; margin-top: 5px;"></td>
                <td> Paysense Bank </td>
                <td>16.25%</td>
            </tr>
        </tbody>
